...
NDefines.NRulerDesigner.COST_COMBAT_RATING = 1.0
...
NDefines.NDiplomacy.MAX_INFAMY_GAIN = 20.0									-- This is the max infamy gained from a single source
...
NDefines.NInfamy.MIN_INFAMY_DECAY = 0.15									-- The minimum infamy decay regardless of troop strength.
NDefines.NInfamy.MAX_INFAMY_DECAY = 0.30									-- The maximum infamy decay regardless of troop strength.
NDefines.NInfamy.MAX_INFAMY_PER_WAR_PROVINCE = 4.0							-- A single province taken in war can give at most this much threat
NDefines.NInfamy.MIN_INFAMY_PER_WAR_PROVINCE = 1.0							-- A single province taken in war can give at most this much threat
